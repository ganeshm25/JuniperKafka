...
package com.juniper.kafka.pubsub.sink;
...
import com.juniper.kafka.pubsub.common.ConnectorUtils;
import com.juniper.kafka.pubsub.common.ConnectorCredentialsProvider;
...
public com.google.cloud.pubsub.v1.Publisher getPublisher() {
	return publisher;
}

public void setPublisher(com.google.cloud.pubsub.v1.Publisher publisher) {
	this.publisher = publisher;
}
...
@Override
  ...
  public void publishMessage(String topic, Integer partition, PubsubMessage message) {
        ...
        com.google.cloud.pubsub.v1.Publisher.newBuilder(fullTopic)
            ...
            .setBatchingSettings(
                BatchingSettings.newBuilder()
                    ...
                    .setElementCountThreshold((long) 1000)
                    .setRequestByteThreshold((long) 1000)
                    .build())
            .setRetrySettings(
                RetrySettings.newBuilder()
                    // All values that are not configurable come from the defaults for the publisher
                    // client library.
                    .setTotalTimeout(Duration.ofMillis(10000))
